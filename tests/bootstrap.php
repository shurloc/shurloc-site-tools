...
require_once __DIR__ . '/doubles/class-test-admin-page.php';
require_once __DIR__ . '/doubles/class-wc-datetime.php';
require_once __DIR__ . '/doubles/class-wc-breadcrumb.php';
...
require_once __DIR__ . '/doubles/class-test-fee.php';
require_once __DIR__ . '/doubles/class-test-session.php';
